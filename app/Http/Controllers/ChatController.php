...
class ChatController extends Controller
{
    ...
    {
        $user = Auth::user(); // ou toute autre logique pour obtenir l'utilisateur
        $chatData = [
            'userUrl' => url('/user') // Remplacez ceci par la logique pour obtenir l'URL de l'utilisateur
        ];

        return view('chat', compact('user', 'chatData'));
    }
